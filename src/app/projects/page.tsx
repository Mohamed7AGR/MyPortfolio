...
const ProjectsPage = () => {
  return (
    <section
      id="projects"
      className="relative min-h-screen overflow-hidden w-full min-w-0"
    >
      ...
      <div className="flex flex-col gap-12 sm:gap-16 items-center container mx-auto py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative z-10 w-full max-w-full min-w-0">
        <div className="max-w-3xl text-center flex flex-col gap-4 sm:gap-6 px-2">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-400 leading-relaxed font-medium italic">
